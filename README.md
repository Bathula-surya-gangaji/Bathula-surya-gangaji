...
I am a **Software Engineer** with production experience building **scalable, secure, and high-reliability systems**. I focus on:
 ...
 ⚙️ **Backend Architecture:** Java, Spring Boot, Microservices, REST, gRPC, JWT/OAuth2  
 🚀 **Performance Engineering:** Query tuning, indexing, API latency reduction  
 🔐 **Security:** Vulnerability remediation, secure APIs, dependency upgrades  
 📊 **Observability:** Metrics, dashboards, structured logging, tracing  
...
**Tech:** Java, Spring Boot, Docker, Kafka, AWS, gRPC  

- Built a **production-grade microservices system** for scalable healthcare workflows  
- Designed **event-driven architecture** using Kafka + gRPC  
- Implemented **JWT authentication with Spring Security**  
- Deployed on **AWS (EC2, API Gateway, CloudFormation/CDK)**  
- Built automated **CI/CD pipelines**  
- Added **observability, health checks, and resilience patterns**

 🏀 **NBA Management System**
**Tech:** Flask, MySQL, HTML, CSS, Bootstrap  

- Full-stack CRUD app for teams, players, and schedules  
...
- Built real-time pose estimation model  
- Improved accuracy by **15%** over baseline  
- Reduced inference time by **20%** using GPU optimization  
...
**NeuralHackS6 Hackathon Finalist (Virtusa)**  
- Top 100 among hundreds of teams  
- Built scalable app using Python + React + REST  
- Won **“Best Visual Treat – II”** for UI/UX excellence  
